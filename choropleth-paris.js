...
var dataCSV = "reviews-paris.csv"

var geojsonURL = "neighbourhoods-paris.geojson"
...
d3.json(geojsonURL, function(error, json){
    d3.csv(dataCSV, function(error, data){
      ...
      function onEachFeature(feature, layer) {
        ...
        layer.bindTooltip('<center><b>Neighbourhood:</b> ' + feature.properties.neighbourhood + '<hr/><b>Number Of Bookings:</b> ' + feature.properties.value.toLocaleString() + '</center>');
      }
